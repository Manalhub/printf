...
/**
 * theprint - function that selects the correct function to perform the operation
 * asked by the user.
 ...
 * parameter. Example: if s is passed as a parameter, this function will return
 * a pointer to the function print_s.
